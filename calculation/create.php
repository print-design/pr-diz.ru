                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           placeholder="Толщина" 
                                           value="<?= empty($other_thickness) ? '' : floatval($other_thickness) ?>" 
                                           onmousedown="javascript: $(this).removeAttr('id'); $(this).removeAttr('name'); $(this).removeAttr('placeholder');" 
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               class="form-control int-only" 
                                               placeholder="Толщина" 
                                               value="<?= empty($lamination1_other_thickness) ? '' : $lamination1_other_thickness ?>" 
                                               onmousedown="javascript: $(this).removeAttr('id'); $(this).removeAttr('name'); $(this).removeAttr('placeholder');" 
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="form-control int-only" 
                                                   placeholder="Толщина" 
                                                   value="<?= empty($lamination2_other_thickness) ? '' : $lamination2_other_thickness ?>" 
                                                   onmousedown="javascript: $(this).removeAttr('id'); $(this).removeAttr('name'); $(this).removeAttr('placeholder');" 
