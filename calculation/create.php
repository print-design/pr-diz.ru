                                ...
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               class="form-control float-only" 
                                               placeholder="Цена" 
                                               value="<?= floatval($lamination1_other_price) ?>" 
                                               onmousedown="javascript: $(this).removeAttr('id'); $(this).removeAttr('name'); $(this).removeAttr('placeholder');" 
                                ...
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               class="form-control float-only" 
                                               placeholder="Удельный вес" 
                                               value="<?= floatval($lamination1_other_weight) ?>" 
                                               onmousedown="javascript: $(this).removeAttr('id'); $(this).removeAttr('name'); $(this).removeAttr('placeholder');" 
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="form-control float-only" 
                                                   placeholder="Цена" 
                                                   value="<?= floatval($lamination2_other_price) ?>" 
                                                   onmousedown="javascript: $(this).removeAttr('id'); $(this).removeAttr('name'); $(this).removeAttr('placeholder');" 
                                    ...
                                    <div class="col-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="form-control float-only" 
                                                   placeholder="Удельный вес" 
                                                   value="<?= floatval($lamination2_other_weight) ?>" 
                                                   onmousedown="javascript: $(this).removeAttr('id'); $(this).removeAttr('name'); $(this).removeAttr('placeholder');" 
