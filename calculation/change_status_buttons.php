...
<div class="d-flex justify-content-between">
    <div>
        <form method="post" action="details.php?id=<?= filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT) ?>">
...
<div class="d-flex justify-content-start">
    <form method="post" action="details.php<?= BuildQuery('id', filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT)) ?>">
        <input type="hidden" name="<?= CSRF_TOKEN ?>" value="<?= $_SESSION[CSRF_TOKEN] ?>" />
        <input type="hidden" name="id" value="<?= filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT) ?>" />
    ...
    <form method="post" action="details.php<?= BuildQuery('id', filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT)) ?>" class="ml-4">
        <input type="hidden" name="<?= CSRF_TOKEN ?>" value="<?= $_SESSION[CSRF_TOKEN] ?>" />
        <input type="hidden" name="id" value="<?= filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT) ?>" />
