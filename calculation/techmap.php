                ...
                <div class="col-3">
                    ...
                    <div class="d-flex justify-content-between pb-2">
                        <div id="mini_image1_wrapper_printing_<?=$printing['id'] ?>" class="w-50 <?=$image1_wrapper_class ?>">
                            ...
                            С подписью <a href="javascript: void(0);" data-toggle="modal" data-target="#confirm_delete" style="font-weight: bold; font-size: x-large; vertical-align: central;" onclick="javascript: $('#deleted_file_name').text('<?=$printing['image1'] ?>'); document.forms.delete_image_form.object.value = 'printing'; document.forms.delete_image_form.id.value = <?=$printing['id'] ?>; document.forms.delete_image_form.image.value = 1;">&times;</a>
                        </div>
                        <div id="mini_image2_wrapper_printing_<?=$printing['id'] ?>" class="w-50 <?=$image2_wrapper_class ?>">
                            ...
                            Без подписи <a href="javascript: void(0);" data-toggle="modal" data-target="#confirm_delete" style="font-weight: bold; font-size: x-large; vertical-align: central;" onclick="javascript: $('#deleted_file_name').text('<?=$printing['image2'] ?>'); document.forms.delete_image_form.object.value = 'printing'; document.forms.delete_image_form.id.value = <?=$printing['id'] ?>; document.forms.delete_image_form.image.value = 2;">&times;</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
