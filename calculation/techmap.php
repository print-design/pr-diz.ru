            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flex justify-content-between">
                        ...
                        <div>
                            <button type="button" class="btn btn-light" id="big_image_left" style="font-size: x-large;" onclick="javascript: document.forms.delete_image_form.image.value = 1; document.forms.download_image_form.image.value = 1; $('#big_image_img').attr('src', '../content/stream/' + $('#mini_image1_link_stream_' + document.forms.download_image_form.id.value).attr('data-filename')); $('#deleted_file_name').text($('#big_image_header').text() + ', с подписью заказчика'); $('#big_image_left').addClass('disabled'); $('#big_image_right').removeClass('disabled');">&lt;</button>
                            <button type="button" class="btn btn-light" id="big_image_right" style="font-size: x-large;" onclick="javascript: document.forms.delete_image_form.image.value = 2; document.forms.download_image_form.image.value = 2; $('#big_image_img').attr('src', '../content/stream/' + $('#mini_image2_link_stream_' + document.forms.download_image_form.id.value).attr('data-filename')); $('#deleted_file_name').text($('#big_image_header').text() + ', без подписи заказчика'); $('#big_image_right').addClass('disabled'); $('#big_image_left').removeClass('disabled');">&gt;</button>
                        </div>
                    </div>
                </div>
            </div>
