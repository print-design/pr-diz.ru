...
?>
<button type="button" id="find-append" class="flexim-icon-btn<?=$append_class ?>" aria-label="Поиск"><span data-flexim-icon="search" data-size="24" aria-hidden="true"></span></button>
