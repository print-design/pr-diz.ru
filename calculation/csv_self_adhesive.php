...
if($id !== null) {
    ...
    array_push($file_data, array("Толщина", CalculationBase::Display($calculation->thickness_1, 2), "", ""));
    array_push($file_data, array("Плотность", CalculationBase::Display($calculation->density_1, 2), "", ""));
    array_push($file_data, array("Лыжи", $calculation->GetSkiName($calculation->ski_1), "", ""));
    if($calculation->ski_1 == CalculationBase::NONSTANDARD_SKI) array_push ($file_data, array("Ширина материала, мм", CalculationBase::Display ($calculation->width_ski_1, 2), "", ""));
    if($calculation->customers_material_1 == true) array_push ($file_data, array("Материал заказчика", "", "", ""));
    else array_push ($file_data, array("Цена", CalculationBase::Display ($calculation->price_1, 2)." ".$calculation->GetCurrencyName ($calculation->currency_1).($calculation->currency_1 == CalculationBase::USD ? " (".CalculationBase::Display ($calculation->price_1 * $calculation->usd, 2)." руб)" : "").($calculation->currency_1 == CalculationBase::EURO ? " (".CalculationBase::Display ($calculation->price_1 * $calculation->euro, 2)." руб)" : ""), "", ""));
    ...
    array_push($file_data, array("Дополнительные расходы с шт, руб", CalculationBase::Display($calculation->extra_expense, 3), "", ""));
        
    array_push($file_data, array("ЗазорРапорт", CalculationBase::Display($calculation->data_gap->gap_raport, 2), "", ""));
    array_push($file_data, array("ЗазорРучей", CalculationBase::Display($calculation->data_gap->gap_stream, 2), "", ""));
    ...
    array_push($file_data, array("Ширина материала, мм",
        ...
        $calculation->ski_1 == CalculationBase::NONSTANDARD_SKI ? "|= ".CalculationBase::Display($calculation->width_ski_1, 2) : "|= ($calculation->streams_number * (".CalculationBase::Display($calculation->stream_width, 2)." + ".CalculationBase::Display($calculation->data_gap->gap_stream, 2).")) + (".CalculationBase::Display($calculation->data_gap->ski, 2)." * 2)",
    ...
    array_push($file_data, array("Высота этикетки грязная, мм",
        ...
        "|= ". CalculationBase::Display($calculation->length, 2)." + ". CalculationBase::Display($calculation->data_gap->gap_raport, 2),
    ...
    array_push($file_data, array("Ширина этикетки грязная, мм",
        ...
        "|= ". CalculationBase::Display($calculation->stream_width, 2)." + ". CalculationBase::Display($calculation->data_gap->gap_stream, 2),
    ...
    array_push($file_data, array("Количество этикеток в рапорте грязное",
        ...
        "|= ". CalculationBase::Display($calculation->raport, 2)." / ". CalculationBase::Display($calculation->length_label_dirty, 2),
    ...
    array_push($file_data, array("Фактический зазор, мм",
        ...
        "|= (".CalculationBase::Display($calculation->raport, 2)." - (".CalculationBase::Display($calculation->length, 2)." * ".CalculationBase::Display($calculation->number_in_raport_pure, 2).")) / ".$calculation->number_in_raport_pure,
    ...
    array_push($file_data, array("Метраж приладки одного тиража",
        ...
        "|= ($calculation->ink_number * ". CalculationBase::Display($calculation->data_priladka->length, 0).") + ".CalculationBase::Display($calculation->data_priladka->stamp, 0),
    ...
    array_push($file_data, array("М2 чистые, м2", 
        ...
        "|= (".CalculationBase::Display($calculation->length, 2)." + ".CalculationBase::Display($calculation->gap, 2).") * (".CalculationBase::Display($calculation->stream_width, 2)." + ".CalculationBase::Display($calculation->data_gap->gap_stream, 2).") * ". CalculationBase::Display($calculation->quantity, 0)." / 1 000 000",
    ...
    array_push($file_data, array("М. пог. чистые, м",
        ...
        "|= ".CalculationBase::Display($calculation->area_pure, 2)." / (".CalculationBase::Display($calculation->width_dirty, 2)." * $calculation->streams_number / 1000)",
    ...
    array_push($file_data, array("СтартСтопОтход, м",
        ...
        "|= ". CalculationBase::Display($calculation->data_priladka->waste_percent, 2)." * ". CalculationBase::Display($calculation->length_pog_pure, 2)." / 100",
    ...
    array_push($file_data, array("Масса материала чистая (без приладки), кг",
        ...
        "|= ". CalculationBase::Display($calculation->length_pog_pure, 2)." * ". CalculationBase::Display($calculation->width_mat, 2)." * ". CalculationBase::Display($calculation->density_1, 2)." / 1 000 000",
    ...
    array_push($file_data, array("Масса материала грязная (с приладкой), кг",
        ...
        "|= ". CalculationBase::Display($calculation->area_dirty, 2)." * ". CalculationBase::Display($calculation->density_1, 2)." / 1000",
    ...
    array_push($file_data, array("Себестоимость материала грязная (с приладкой), руб",
        ...
        "|= ". CalculationBase::Display($calculation->area_dirty, 2)." * ". CalculationBase::Display($calculation->price_1, 2)." * ".CalculationBase::Display(CalculationBase::GetCurrencyRate($calculation->currency_1, $calculation->usd, $calculation->euro), 2),
    ...
    array_push($file_data, array("Время приладки, ч",
        ...
        "|= $calculation->ink_number"." * ".CalculationBase::Display($calculation->data_priladka->time, 2)." / 60 * ".$calculation->quantities_count,
    ...
    array_push($file_data, array("Время печати тиража, без приладки, ч",
        ...
        "|= (". CalculationBase::Display($calculation->length_pog_pure, 2)." + ". CalculationBase::Display($calculation->waste_length, 2).") / ". CalculationBase::Display($calculation->data_machine->speed, 2)." / 1000",
    ...
    array_push($file_data, array("Стоимость выполнения, руб",
        ...
        "|= ". CalculationBase::Display($calculation->work_time, 2)." * ". CalculationBase::Display($calculation->data_machine->price, 2),
    ...
    array_push($file_data, array("М2 запечатки, м2",
        ...
        "|= ((". CalculationBase::Display($calculation->stream_width, 2)." + ". CalculationBase::Display($calculation->data_gap->gap_stream, 2).") * (". CalculationBase::Display($calculation->length, 2)." + ". CalculationBase::Display($calculation->data_gap->gap_raport, 2).") * ". CalculationBase::Display($calculation->quantity, 0)." / 1 000 000".") + (". CalculationBase::Display($calculation->length_pog_dirty, 2)." * 0,01)",
    ...
    array_push($file_data, array("Цена 1 кг чистого этоксипропанола, руб",
        ...
        "|= ". CalculationBase::Display($calculation->data_ink->solvent_etoxipropanol_price, 2)." * ".CalculationBase::Display(CalculationBase::GetCurrencyRate($calculation->data_ink->solvent_etoxipropanol_currency, $calculation->usd, $calculation->euro), 2),
    ...
    array_push($file_data, array("М2 испарения грязная, м2",
        ...
        "|= ". CalculationBase::Display($calculation->data_machine->width, 0)." * ". CalculationBase::Display($calculation->length_pog_dirty, 2)." / 1000",
    ...
    array_push($file_data, array("Расход испарения растворителя, кг",
        ...
        "|= ". CalculationBase::Display($calculation->vaporization_area_pure, 2)." * ". CalculationBase::Display($calculation->data_machine->vaporization_expense, 2),
    ...
    for($i=1; $i<=$calculation->ink_number; $i++) {
        ...
        if(get_object_vars($calculation)[$ink] == CalculationBase::LACQUER) {
            array_push($file_data, array("Цена 1 кг чистой краски $i, руб",
                ...
                "|= ". CalculationBase::Display($calculation->data_ink->self_adhesive_laquer_price, 2)." * ". CalculationBase::Display($calculation->GetCurrencyRate($calculation->data_ink->self_adhesive_laquer_currency, $calculation->usd, $calculation->euro), 2),
            ...
            array_push($file_data, array("Расход чистой краски $i, кг",
                ...
                "|= ".CalculationBase::Display($calculation->print_area, 2)." * ".CalculationBase::Display($calculation->data_ink->self_adhesive_laquer_expense, 2)." * ".CalculationBase::Display(get_object_vars($calculation)[$percent], 2)." / 1000 / 100",
            ...
            array_push($file_data, array("Цена 1 кг чистой краски $i, руб",
                CalculationBase::Display($calculation->ink_kg_prices[$i], 2),
                "|= ". CalculationBase::Display($price1->value, 2)." * ". CalculationBase::Display($calculation->GetCurrencyRate($price1->currency, $calculation->usd, $calculation->euro), 2),
                "цена 1 кг чистой краски $i * курс валюты"));
            
            array_push($file_data, array("Цена 1 кг КраскаСмеси $i, руб",
                CalculationBase::Display($calculation->mix_ink_kg_prices[$i], 2),
                "|= ((".CalculationBase::Display($calculation->ink_kg_prices[$i], 2)." * 1) + (".CalculationBase::Display($calculation->ink_etoxypropanol_kg_price, 2)." * ".CalculationBase::Display($calculation->data_ink->solvent_part, 2).")) / ".CalculationBase::Display($calculation->ink_1kg_mix_weight, 2),
    ...
    array_push($file_data, array("Высота форм, м",
        ...
        "|= (".CalculationBase::Display($calculation->raport, 2)." + 20) / 1000",
        "(рапорт + 20мм) / 1000"));
        
    array_push($file_data, array("Ширина форм, м",
        CalculationBase::Display($calculation->cliche_width, 2),
        "|= (".CalculationBase::Display($calculation->streams_number, 2)." * ".CalculationBase::Display($calculation->width_dirty, 2)." + 20 + 20) / 1000",
    ...
    array_push($file_data, array("Себестоимость 1 формы Флинт, руб",
        ...
        "|= ".CalculationBase::Display($calculation->cliche_area, 2)." * 10000 * ".CalculationBase::Display($calculation->data_cliche->flint_price, 2)." * ".CalculationBase::Display(CalculationBase::GetCurrencyRate($calculation->data_cliche->flint_currency, $calculation->usd, $calculation->euro), 2),
    ...
    array_push($file_data, array("Себестоимость 1 формы Кодак, руб",
        ...
        "|= ".CalculationBase::Display($calculation->cliche_area, 2)." * 10000 * ".CalculationBase::Display($calculation->data_cliche->kodak_price, 2)." * ".CalculationBase::Display(CalculationBase::GetCurrencyRate($calculation->data_cliche->kodak_currency, $calculation->usd, $calculation->euro), 2),
    ...
    array_push($file_data, array("Себестоимость всех форм Флинт, руб",
        ...
        "|= $calculation->cliches_count_flint * ".CalculationBase::Display($calculation->cliche_flint_price, 2),
    ...
    array_push($file_data, array("Себестоимость всех форм Кодак, руб",
        ...
        "|= $calculation->cliches_count_kodak * ".CalculationBase::Display($calculation->cliche_kodak_price, 2),
    ...
    array_push($file_data, array("Себестоимость ножа, руб",
        ...
        "|= ".CalculationBase::Display($calculation->knife, 2),
    ...
    array_push($file_data, array("Отходы, руб",
        ...
        "|= ".CalculationBase::Display($calculation->film_waste_weight, 2)." * ".CalculationBase::Display($calculation->price_1, 2)." * ".CalculationBase::Display(CalculationBase::GetCurrencyRate($calculation->currency_1, $calculation->usd, $calculation->euro), 2),
    ...
    foreach($calculation->quantities as $key => $quantity) {
        array_push($file_data, array("Длина тиража $i, м",
            ...
            "|= (".CalculationBase::Display(intval($calculation->length), 2)." + ".CalculationBase::Display($calculation->gap, 2).") * ".CalculationBase::Display(intval($calculation->quantities[$key]), 0)." / $calculation->streams_number / 1000",
