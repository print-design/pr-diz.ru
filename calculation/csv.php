...
if($id !== null) {
    ...
    else array_push ($file_data, array("Цена 1", CalculationBase::Display($calculation->price_1, 5)." ". $calculation->GetCurrencyName($calculation->currency_1).($calculation->currency_1 == CURRENCY_USD ? " (". CalculationBase::Display($calculation->price_1 * $calculation->usd, 5)." руб)" : "").($calculation->currency_1 == Calculation::EURO ? " (". CalculationBase::Display($calculation->price_1 * $calculation->euro, 5)." руб)" : ""), "", ""));
    ...
    if($calculation->laminations_number > 0) {
        ...
        else array_push ($file_data, array("Цена 2", CalculationBase::Display($calculation->price_2, 5)." ". $calculation->GetCurrencyName($calculation->currency_2).($calculation->currency_2 == CURRENCY_USD ? " (".CalculationBase::Display($calculation->price_2 * $calculation->usd, 5)." руб)" : "").($calculation->currency_2 == Calculation::EURO ? " (".CalculationBase::Display($calculation->price_2 * $calculation->euro, 5)." руб)" : ""), "", ""));
    }
    ...
    if($calculation->laminations_number > 1) {
        ...
        else array_push ($file_data, array("Цена 3", CalculationBase::Display($calculation->price_3, 5)." ". $calculation->GetCurrencyName($calculation->currency_3).($calculation->currency_3 == CURRENCY_USD ? " (".CalculationBase::Display($calculation->price_3 * $calculation->usd, 5)." руб)" : "").($calculation->currency_3 == Calculation::EURO ? " (".CalculationBase::Display($calculation->price_3 * $calculation->euro, 5)." руб)" : ""), "", ""));
    }
