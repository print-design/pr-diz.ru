...
$status_names = array(DRAFT => "Черновик", CALCULATION => "Сделан расчёт", WAITING => "Ждём подтверждения", CONFIRMED => "Одобрено", REJECTED => "Отклонено", TECHMAP => "Составлена тех. карта", TRASH => "В корзине", PLAN => "В плане");
$status_colors = array(DRAFT => "gray", CALCULATION => "steelblue", WAITING => "goldenrod", CONFIRMED => "mediumseagreen", REJECTED => "indianred", TECHMAP => "saddlebrown", TRASH => "black", PLAN => "purple");
