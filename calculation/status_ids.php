...
$status_colors = array(DRAFT => "gray", CALCULATION => "steelblue", WAITING => "goldenrod", CONFIRMED => "mediumseagreen", REJECTED => "crimson", TECHMAP => "saddlebrown", TRASH => "black", PLAN => "purple");
