...
class Calculation {
    ...
    public function __construct(TuningData $tuning_data, 
        ...
        $this->mpure = new CalculationItem("Масса плёнки чистая (осн), кг", $this->mpogpure->value * $this->width->value * $density / 1000, "|= ".$this->mpogpure->display." * ".$this->width->display." * ".$density_display." / 1000", "м. пог. чистые * ширина материала осн * уд. вес / 1000");
