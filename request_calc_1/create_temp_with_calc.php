...
if(null !== filter_input(INPUT_POST, 'create_request_calc_submit')) {
    ...
    if($form_valid) {
        ...
        if(empty($error_message)) {
            ...
            elseif(!empty ($lamination1_brand_name) && $lamination1_thickness != "NULL") {
                $c_density_lam1 = null;
            ...
            if(!empty($lamination1_brand_name) && $lamination1_thickness != "NULL" && empty($c_density_lam1)) {
        ...
        if(empty($error_message)) {
            ...
            elseif(!empty ($lamination2_brand_name) && $lamination2_thickness != "NULL") {
                $c_density_lam2 = null;
            ...
            if(!empty($lamination2_brand_name) && $lamination2_thickness != "NULL" && empty($c_density_lam2)) {
    ...
    // Сохранение расчёта в базу
        ...
        if(empty($error_message)) {
            // Если всё в порядке, перенаправляем на страницу заполненной формы с правой панелью результатов
