<tr>
    ...
    <td class="<?=$this->cut_shift->shift ?>">
        <a class="btn btn-light" href="details.php?id=<?=$this->edition['calculation_id'] ?><?= empty(filter_input(INPUT_GET, 'machine_id')) ? '' : "&machine_id=". filter_input(INPUT_GET, 'machine_id') ?>">Приступить</a>
    </td>
</tr>