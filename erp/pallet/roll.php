        ...
        <div class="container-fluid" style="padding-left: 40px;">
            ...
            <form method="post">
                ...
                <div class="form-inline" style="margin-top: 30px;">
                    ...
                    <a href="print.php?id=<?=$pallet_id ?>" class="btn btn-outline-dark" style="padding-top: 5px; padding-bottom: 5px; padding-left: 50px; padding-right: 50px;">Распечатать<br />стикер</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
