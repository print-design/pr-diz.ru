...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit_payment_submit'])) {
    if($_POST['date'] == '') {
    ...
    if($form_valid) {
        ...
        $sql = "update payment set date=$timestamp, sum=$sum where id = ".$id;
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="date" name="date" class="form-control<?=$date_valid ?>" value="<?=$_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['date']) ? $_POST['date'] : $date ?>" autocomplete="off" required="required"/>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" id="sum" name="sum" class="form-control<?=$sum_valid ?>" value="<?=$_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['sum']) ? $_POST['sum'] : $sum ?>" autocomplete="off" required="required"/>
                                    <div class="invalid-feedback">Сумма обязательно, число</div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <button type="submit" id="edit_payment_submit" name="edit_payment_submit" class="btn btn-outline-dark">Сохранить</button>
                        </div>
                    </form>
                </div>
            </div>
