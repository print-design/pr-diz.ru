...
?>
<button type="button" class="btn btn-link mr-2 ml-auto<?=$append_class ?>" id="find-append" style="border-top-right-radius: 5px; border-bottom-right-radius: 5px; color: black; font-size: small;"><i class="fas fa-search"></i></button>
<form class="form-inline ml-auto mr-3<?=$find_class ?>" method="get" id="find-form" action="<?=APPLICATION.'/pallet/' ?>">
