...
<tr data-date="<?=$this->date->format('Y-m-d') ?>" data-shift="<?=$this->shift ?>" data-id="<?=$this->edition['calculation_id'] ?>" data-position="<?=$this->edition['position'] ?>">
    ...
    ?>
    <td class="<?=$this->shift ?> showdropline border-left fordrag"<?=$drop ?>>
    ...
    <td colspan="5" class="<?=$this->shift ?> showdropline"<?=$drop ?>>
        <?= $this->edition['calculation'] ?>
    </td>
    <td class="<?=$this->shift ?> showdropline"<?=$drop ?>><?= CalculationBase::Display(floatval($this->edition['worktime']), 2) ?></td>
    <td class="<?=$this->shift ?> showdropline"<?=$drop ?>></td>
    <td class="<?=$this->shift ?> showdropline text-right" style="position: relative;"<?=$drop ?>>
    ...
    <td class="<?=$this->shift ?> showdropline"<?=$drop ?>><?= rtrim(rtrim(CalculationBase::Display(floatval($this->edition['raport']), 3), "0"), ",") ?></td>
    <td class="<?=$this->shift ?> showdropline"<?=$drop ?>><?=$this->edition['laminations'] ?></td>
    <td class="<?=$this->shift ?> showdropline"<?=$drop ?>><?=$this->edition['ink_number'] ?></td>
    <td class="<?=$this->shift ?> showdropline"<?=$drop ?>><?= CalculationBase::Display(floatval($this->edition['worktime']), 2) ?></td>
    <td class="<?=$this->shift ?> showdropline"<?=$drop ?>><?=$this->edition['manager'] ?></td>
    <td class="<?=$this->shift ?> showdropline text-right"<?=$drop ?>>
