<tr>
    ...
    <td class="<?=$top.' '.$this->shift ?> border-right text-nowrap">
        <?php
    ...
    <td class="<?=$top.' '.$this->shift ?> not_colorist_hidden"></td>
    <td class="<?=$top.' '.$this->shift ?> storekeeper_hidden colorist_hidden"></td>
