            ...
            <div class="d-flex justify-content-end">
                ...
                <div style="position: relative; padding-top: 10px;">
                    ...
                    <div class="queue_menu text-left">
                        <div>
                            <a class="btn btn-link h-25 w-100 text-left" style="font-size: 14px;" href="../calculation/<?= IsInRole(array(ROLE_NAMES[ROLE_SCHEDULER], ROLE_NAMES[ROLE_LAM_HEAD], ROLE_NAMES[ROLE_FLEXOPRINT_HEAD])) || /*ВРЕМЕННО*/ GetUserId() == CUTTER_SOMA ? "print_tm" : "techmap" ?>.php?id=<?=$row['calculation_id'] ?>"<?= IsInRole(array(ROLE_NAMES[ROLE_SCHEDULER], ROLE_NAMES[ROLE_LAM_HEAD], ROLE_NAMES[ROLE_FLEXOPRINT_HEAD])) || /*ВРЕМЕННО*/ GetUserId() == CUTTER_SOMA ? " target='_blank'" : "" ?>>
                                <div class="command">
