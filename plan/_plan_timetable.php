...
class PlanTimetable {
    ...
    public function __construct($work_id, $machine_id, $dateFrom, $dateTo) {
        ...
        // Тиражи
        $sql = "select e.id id, e.date, e.shift, ".PLAN_TYPE_EDITION." as type, if(isnull(e.worktime_continued), 0, 1) as has_continuation, ifnull(e.worktime_continued, e.worktime) worktime, e.position, c.id calculation_id, c.name calculation, c.raport, c.ink_number, c.status_id, c.cut_remove_cause, cr.length_pure_1 as length_total, "
                ...
                . "union "
                . "select ev.id, ev.date, ev.shift, ".PLAN_TYPE_EVENT." as type, 0 as has_continuation, ev.worktime, ev.position, ev.id calculation_id, ev.text calculation, 0 as raport, 0 as ink_number, 0 as status_id, '' as cut_remove_cause, 0 as length_total, "
                . "0 as length_pure_1, "
                . "0 as length_pure_2, "
                . "0 as length_pure_3, "
                . "0 as length_dirty_1, "
                ...
                . "union "
                . "select pc.id, pc.date, pc.shift, ".PLAN_TYPE_CONTINUATION." as type, pc.has_continuation, pc.worktime, 1 as position, c.id calculation_id, c.name calculation, c.raport, c.ink_number, 0 as status_id, '' as cut_remove_cause, cr.length_pure_1 as length_total, "
                ...
                . "union "
                . "select pp.id, pp.date, pp.shift, ".PLAN_TYPE_PART." as type, if(isnull(pp.worktime_continued), 0, 1) as has_continuation, ifnull(pp.worktime_continued, pp.worktime) worktime, pp.position, c.id calculation_id, c.name calculation, c.raport, c.ink_number, c.status_id, c.cut_remove_cause, cr.length_pure_1 as length_total, "
                ...
                . "union "
                . "select ppc.id, ppc.date, ppc.shift, ".PLAN_TYPE_PART_CONTINUATION." as type, ppc.has_continuation, ppc.worktime, 1 as position, c.id calculation_id, c.name calculation, c.raport, c.ink_number, 0 as status_id, '' as cut_remove_cause, cr.length_pure_1 as length_total, "
