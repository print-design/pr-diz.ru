...
class PlanTimetable {
    ...
    public function __construct($work_id, $machine_id, $dateFrom, $dateTo) {
        ...
        if((IsInRole(array(ROLE_NAMES[ROLE_TECHNOLOGIST], ROLE_NAMES[ROLE_SCHEDULER], ROLE_NAMES[ROLE_LAM_HEAD])) || /*ВРЕМЕННО*/ GetUserId() == CUTTER_SOMA) 
                && !(IsInRole(ROLE_NAMES[ROLE_SCHEDULER]) && ($this->work_id == WORK_LAMINATION || $this->work_id == WORK_CUTTING)) 
                && !(IsInRole(ROLE_NAMES[ROLE_LAM_HEAD]) && $this->work_id != WORK_LAMINATION && $this->work_id != WORK_CUTTING)) {
            $this->editable = true;
        }
        ...
        $sql = "select e.id id, e.date, e.shift, ".PLAN_TYPE_EDITION." as type, if(isnull(e.worktime_continued), 0, 1) as has_continuation, ifnull(e.worktime_continued, e.worktime) worktime, e.position, c.id calculation_id, c.name calculation, c.raport, c.lamination_roller_width, c.length, c.stream_width, c.streams_number, c.ink_number, c.ink_run2_number, c.unit, c.quantity, "
                ...
                . "cr.width_1, cr.width_2, cr.width_3, cr.length_dirty_1 as length_dirty_1_total, "
                . "c.work_type_id, c.customer_id, cus.name customer, c.manager_id, u.first_name, u.last_name, "
                . "c.ink_1, c.ink_2, c.ink_3, c.ink_4, c.ink_5, c.ink_6, c.ink_7, c.ink_8, c.ink_run2_1, c.ink_run2_2, c.ink_run2_3, c.ink_run2_4, "
                . "c.color_1, c.color_2, c.color_3, c.color_4, c.color_5, c.color_6, c.color_7, c.color_8, c.color_run2_1, c.color_run2_2, c.color_run2_3, c.color_run2_4, "
                . "c.cmyk_1, c.cmyk_2, c.cmyk_3, c.cmyk_4, c.cmyk_5, c.cmyk_6, c.cmyk_7, c.cmyk_8, c.cmyk_run2_1, c.cmyk_run2_2, c.cmyk_run2_3, c.cmyk_run2_4, "
                . "c.lacquer_1, c.lacquer_2, c.lacquer_3, c.lacquer_4, c.lacquer_5, c.lacquer_6, c.lacquer_7, c.lacquer_8, c.lacquer_run2_1, c.lacquer_run2_2, c.lacquer_run2_3, c.lacquer_run2_4, "
                . "c.percent_1, c.percent_2, c.percent_3, c.percent_4, c.percent_5, c.percent_6, c.percent_7, c.percent_8, c.percent_run2_1, c.percent_run2_2, c.percent_run2_3, c.percent_run2_4, "
                ...
                . "e.lamination, e.run2, e.comment, (select count(id) from calculation where customer_id = c.customer_id and id <= c.id) num_for_customer, "
                ...
                . "0 as length_dirty_2, "
                . "0 as length_dirty_3, "
                . "0 as width_1, 0 as width_2, 0 as width_3, 0 as length_dirty_1_total, "
                . "0 as work_type_id, 0 as customer_id, '' as customer, 0 as manager_id, '' as first_name, '' as last_name, "
                . "'' as ink_1, '' as ink_2, '' as ink_3, '' as ink_4, '' as ink_5, '' as ink_6, '' as ink_7, '' as ink_8, '' as ink_run2_1, '' as ink_run2_2, '' as ink_run2_3, '' as ink_run2_4, "
                . "'' as color_1, '' as color_2, '' as color_3, '' as color_4, '' as color_5, '' as color_6, '' as color_7, '' as color_8, '' as color_run2_1, '' as color_run2_2, '' as color_run2_3, '' as color_run2_4, "
                . "'' as cmyk_1, '' as cmyk_2, '' as cmyk_3, '' as cmyk_4, '' as cmyk_5, '' as cmyk_6, '' as cmyk_7, '' as cmyk_8, '' as cmyk_run2_1, '' as cmyk_run2_2, '' as cmyk_run2_3, '' as cmyk_run2_4, "
                . "'' as lacquer_1, '' as lacquer_2, '' as lacquer_3, '' as lacquer_4, '' as lacquer_5, '' as lacquer_6, '' as lacquer_7, '' as lacquer_8, '' as lacquer_run2_1, '' as lacquer_run2_2, '' as lacquer_run2_3, '' as lacquer_run2_4, "
                . "0 as percent_1, 0 as percent_2, 0 as percent_3, 0 as percent_4, 0 as percent_5, 0 as percent_6, 0 as percent_7, 0 as percent_8, 0 as percent_run2_1, 0 as percent_run2_2, 0 as percent_run2_3, 0 as percent_run2_4, "
                ...
                . "0 as lamination, 0 as run2, ev.comment, 0 as status_id, '' as status_comment, 0 as num_for_customer, "
                . "0 as length_cut, "
                . "0 as weight_cut, "
                . "0 as images_count "
                ...
                . "(select status_id from calculation_status_history where calculation_id = c.id order by date desc limit 1) status_id, "
                . "(select comment from calculation_status_history where calculation_id = c.id order by date desc limit 1) status_comment, "
                . "e.lamination, e.run2, pc.comment, (select count(id) from calculation where customer_id = c.customer_id and id <= c.id) num_for_customer, "
                . "ifnull((select sum(length) from calculation_take_stream where calculation_take_id in (select id from calculation_take where calculation_id = c.id)), 0) "
                . "+ ifnull((select sum(length) from calculation_not_take_stream where calculation_stream_id in (select id from calculation_stream where calculation_id = c.id)), 0) length_cut, "
                . "ifnull((select sum(weight) from calculation_take_stream where calculation_take_id in (select id from calculation_take where calculation_id = c.id)), 0) "
                . "+ ifnull((select sum(weight) from calculation_not_take_stream where calculation_stream_id in (select id from calculation_stream where calculation_id = c.id)), 0) weight_cut, "
        ...
        while($row = $fetcher->Fetch()) {
            ...
            if($this->work_id == WORK_PRINTING) {
                ...
                elseif($row['type'] == PLAN_TYPE_CONTINUATION) {
