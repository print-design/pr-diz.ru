...
class PlanTimetable {
    ...
    public function __construct($work_id, $machine_id, $dateFrom, $dateTo) {
        ...
        $sql = "select e.id id, e.date, e.shift, ".PLAN_TYPE_EDITION." as type, if(isnull(e.worktime_continued), 0, 1) as has_continuation, ifnull(e.worktime_continued, e.worktime) worktime, e.position, c.id calculation_id, c.name calculation, c.raport, c.ink_number, c.status_id, "
                ...
                . "0 as customer_id, '' as customer, 0 as manager_id, '' as first_name, '' as last_name, "
                . "'' as film_name, 0 as thickness, '' as individual_film_name, 0 as individual_thickness, "
                . "0 as lamination1_film_variation_id, '' as lamination1_film_name, 0 as lamination1_thickness, '' as lamination1_individual_film_name, 0 as lamination1_individual_thickness, "
                . "0 as lamination2_film_variation_id, '' as lamination2_film_name, 0 as lamination2_thickness, '' as lamination2_individual_film_name, 0 as lamination2_individual_thickness, "
                ...
                . "round(cr.length_pure_1) / round(cr.work_time_1, 2) * pc.worktime as length_pure_1, "
                . "round(cr.length_pure_2) / round(cr.work_time_2, 2) * pc.worktime as length_pure_2, "
                . "round(cr.length_pure_3) / round(cr.work_time_3, 2) * pc.worktime as length_pure_3, "
