...
<div id="left_bar">
    ...
    ?>
    <a href="<?=APPLICATION ?>/calculation/?status=<?= ORDER_STATUS_SHIPPED ?>" class="left_bar_item ui_tooltip right<?=$zakaz_class ?>" data-placement="right" title="Заказы"><img src="<?=APPLICATION ?>/images/nav_clock.svg" /></a>
    <?php
    endif;
    // Склад
