...
$supplier_class = substr(filter_input(INPUT_SERVER, 'PHP_SELF'), 0, strlen(APPLICATION.'/supplier')) == APPLICATION.'/supplier' && substr(filter_input(INPUT_SERVER, 'PHP_SELF'), 0, strlen(APPLICATION.'/supplier/film.php')) != APPLICATION.'/supplier/film.php' ? " active" : "";
$film_class = substr(filter_input(INPUT_SERVER, 'PHP_SELF'), 0, strlen(APPLICATION.'/supplier/film.php')) == APPLICATION.'/supplier/film.php' ? " active" : "";
...
<div class="text-nowrap nav2">
    ...
    <a class="mr-4<?=$film_class ?>" href="<?=APPLICATION ?>/supplier/film.php">Пленка</a>
    <?php if(false): ?>
    <a class="mr-4<?=$price_class ?>" href="<?=APPLICATION ?>/price/">Цены пленки, бумаги</a>
