...
<div class="w-100">
    <form method="post" class="form-inline">
        ...
        <div class="form-group mb-2 mr-2" style="width: 100%;">
            ...
            <select id="pallet_shared_with_id_<?=$id ?>" name="pallet_shared_with_id" class="form-control pallet-shared-with-select" style="width: 320px;">
        ...
        <div class="form-group mb-2 mr-2">
            ...
            <input type="text" id="gross_weight_<?=$id ?>" name="gross_weight" class="form-control float-only float-format pallet-required-field<?=$gross_weight_valid ?>" style="width: 140px;" value="<?= $pallet_fields_disabled ? '' : DisplayNumber($gross_weight, 0) ?>"<?= $pallet_fields_disabled ? '' : ' required="required"' ?> autocomplete="off" />
        </div>
        <div class="form-group mb-2 mr-2">
            <label for="pallet_count_<?=$id ?>">Кол-во паллетов</label>
            <input type="text" id="pallet_count_<?=$id ?>" name="pallet_count" class="form-control int-only pallet-required-field<?=$pallet_count_valid ?>" style="width: 140px;" value="<?= $pallet_fields_disabled ? '' : $pallet_count ?>"<?= $pallet_fields_disabled ? '' : ' required="required"' ?> autocomplete="off" />
        </div>
        <div class="form-group mb-2 mr-2">
            <label for="pallet_length_<?=$id ?>">Длина, м</label>
            <input type="text" id="pallet_length_<?=$id ?>" name="pallet_length" class="form-control float-only float-format pallet-required-field<?=$pallet_length_valid ?>" style="width: 110px;" value="<?= $pallet_fields_disabled ? '' : DisplayNumber($pallet_length, 2) ?>"<?= $pallet_fields_disabled ? '' : ' required="required"' ?> autocomplete="off" />
        </div>
        <div class="form-group mb-2 mr-2">
            <label for="pallet_width_<?=$id ?>">Ширина, м</label>
            <input type="text" id="pallet_width_<?=$id ?>" name="pallet_width" class="form-control float-only float-format pallet-required-field<?=$pallet_width_valid ?>" style="width: 110px;" value="<?= $pallet_fields_disabled ? '' : DisplayNumber($pallet_width, 2) ?>"<?= $pallet_fields_disabled ? '' : ' required="required"' ?> autocomplete="off" />
        </div>
        <div class="form-group mb-2 mr-4">
            <label for="pallet_height_<?=$id ?>">Высота, м</label>
            <input type="text" id="pallet_height_<?=$id ?>" name="pallet_height" class="form-control float-only float-format pallet-required-field<?=$pallet_height_valid ?>" style="width: 110px;" value="<?= $pallet_fields_disabled ? '' : DisplayNumber($pallet_height, 2) ?>"<?= $pallet_fields_disabled ? '' : ' required="required"' ?> autocomplete="off" />
        </div>
