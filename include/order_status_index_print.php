...
if(!empty($status_id)) {
    ...
    if(in_array($status_id, ORDER_STATUSES_WITH_METERS)) {
        echo "<div style='font-size: smaller;'><span class='text-nowrap'>".DisplayNumber(floatval($length_cut), 0)."</span> м из <span class='text-nowrap'>".DisplayNumber(floatval($length_total), 0)."</span></div>";
    }
