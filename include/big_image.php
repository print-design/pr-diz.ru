<div id="big_image" class="modal fade show">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex justify-content-center align-items-baseline align-self-start" style="height: 500px; width: 500px; overflow: auto;"><img id="big_image_img" class="img-fluid" alt="Изображение" style="cursor: zoom-in; position: relative; top: 0px; left: 0px;" onclick="javascript: if($(this).hasClass('img-fluid')) { $(this).removeClass('img-fluid'); $(this).css('cursor', 'zoom-out'); } else { $(this).addClass('img-fluid'); $(this).css('cursor', 'zoom-in'); }" /></div>
