...
const ORDER_STATUSES_IN_CUT = array(ORDER_STATUS_CUT_PRILADKA, ORDER_STATUS_CUTTING, ORDER_STATUS_PACK_READY, ORDER_STATUS_SHIP_READY, ORDER_STATUS_SHIPPED, ORDER_STATUS_CUT_REMOVED);
