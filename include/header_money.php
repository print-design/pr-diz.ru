...
<div class="container-fluid header">
    <nav class="navbar navbar-expand-sm justify-content-end">
        <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link<?=$production_status ?>" href="<?= APPLICATION."/money/" ?>">Производят</a></li>
            <li class="nav-item"><a class="nav-link<?=$money_status ?>" href="<?= APPLICATION."/money/?status_id=".ORDER_STATUS_PACK_READY ?>">Упаковка</a></li>
            <li class="nav-item text-nowrap"><a class="nav-link<?=$ship_status ?>" href="<?= APPLICATION."/money/?status_id=".ORDER_STATUS_SHIP_READY ?>">Ждёт отгрузки</a></li>
            <li class="nav-item"><a class="nav-link<?=$shipped_status ?>" href="<?= APPLICATION."/money/?status_id=".ORDER_STATUS_SHIPPED ?>">Отгружено</a></li>
        </ul>
