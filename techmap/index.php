            ...
            <table class="table table-hover" id="content-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$row['customer'] ?>&nbsp;<a href="javascript: void(0)'" class="customer" data-toggle="modal" data-target="#customerModal" data-customer-id="<?=$row['customer_id'] ?>"><i class="fa fa-question-circle" data-customer-id="<?=$row['customer_id'] ?>"></a></td>
                        <td><?= htmlentities($row['name']) ?></td>
                        <td><a href="details.php<?= BuildQuery("id", $row['id']) ?>"><img src="../images/icons/vertical-dots.svg" /></a></td>
