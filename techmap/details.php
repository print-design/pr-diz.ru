...
$sql = "select tm.calculation_id, tm.date, tm.side, tm.winding, tm.winding_unit, tm.spool, tm.labels, tm.package, tm.roll_type, tm.comment, "
        . "c.date, c.customer_id, c.name calculation, c.quantity, c.unit, c.work_type_id, c.machine_id, "
        ...
        . "from techmap tm "
        . "inner join calculation c on tm.calculation_id = c.id "
                ...
                <div class="col-4">
                    ...
                    <table<?=$work_type_id == CalculationBase::WORK_TYPE_SELF_ADHESIVE ? " class='d-none'" : "" ?>>
                        ...
                        <tr>
                            <td>Намотка до</td>
                            <td>
                                <?= CalculationBase::Display(intval($winding), 0) ?>
                                <?php
                                switch ($winding_unit) {
                                    case 'kg':
                                        echo "кг";
                    ...
                    <image src="../images/roll/roll_type_<?=$roll_type ?>.png" style="height: 30px; width: auto;" />
