...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <?php
            $sql = "select distinct c.id, ifnull(ifnull(ct.time, duplicate_status_date), '1900-01-01') as time, c.customer_id, c.work_type_id, "
                    . "cus.name as customer, c.name as calculation, concat(u.last_name, ' ', left(first_name, 1), '.') as manager, c.raport, c.length, c.unit, c.quantity, c.duplicate_status_date, "
