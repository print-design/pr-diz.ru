                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control float-only<?=$waste_percent_valid ?>" id="waste_percent" name="waste_percent" value="<?= empty($waste_percent) ? "" : intval($waste_percent) ?>" placeholder="Процент отходов на СтартСтоп" required="required" autocomplete="off" />
