...
if(null !== filter_input(INPUT_POST, 'norm_laminator_tuning_submit')) {
    ...
    if($form_valid) {
        ...
        $sql = "select time, length, waste_percent from norm_laminator_tuning order by date desc limit 1";
        ...
        if($old_time != $new_time || $old_length != $new_length || $old_waste_percent != $new_waste_percent) {
            $sql = "insert into norm_laminator_tuning (time, length, waste_percent) values ($new_time, $new_length, $new_waste_percent)";
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            if(null !== filter_input(INPUT_POST, 'norm_laminator_tuning_submit') && empty($error_message)):
            ?>
            ...
            <div class="row">
                <div class="col-12 col-md-4 col-lg-2">
                    <form method="post">
                        ...
                        <button type="submit" id="norm_laminator_tuning_submit" name="norm_laminator_tuning_submit" class="btn btn-dark w-100 mt-5">Сохранить</button>
                    </form>
                </div>
            </div>
        </div>
